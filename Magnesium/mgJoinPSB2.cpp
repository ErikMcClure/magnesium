...
psDebugDraw::psDebugDraw(psDebugDraw&& mov) : psRenderable(std::move(mov)) { SetFlags(static_cast<b2Draw&>(mov).GetFlags()); }
psDebugDraw::psDebugDraw(uint32 flags) { SetFlags(flags); }
